...
### Clean and upload store data to data-base as table
...
### Clean and upload product data to data-base as table        
...
### Clean order data and upload to data-base as a table
...
### Clean events data and upload to data-base as a table
